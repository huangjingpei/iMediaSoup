#define MS_CLASS "Channel::UdpDgramSocket"
// #define MS_LOG_DEV
...
namespace Channel
{
	...
	UdpDgramSocket::UdpDgramSocket()
	  : ::UdpDgramSocket::UdpDgramSocket(NsMessageMaxLen)
	{
		MS_TRACE_STD();
	}

	void UdpDgramSocket::SetListener(Listener* listener)
	{
		MS_TRACE_STD();
	...
	void UdpDgramSocket::Send(json& jsonMessage)
	{
		if (IsClosed())
			return;
	...
	void UdpDgramSocket::SendLog(char* nsPayload, size_t nsPayloadLen)
	{
		if (IsClosed())
			return;
	...
	void UdpDgramSocket::SendBinary(const uint8_t* nsPayload, size_t nsPayloadLen)
	{
		if (IsClosed())
			return;
	...
	void UdpDgramSocket::UserOnUdpDgramRead()
	{
		MS_TRACE_STD();
	...
	void UdpDgramSocket::UserOnUdpDgramSocketClosed(bool isClosedByPeer)
	{
		MS_TRACE_STD();
